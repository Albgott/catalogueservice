package com.albgott.catalogueservice.shared.domain;
...
public final class Utils {
    ...
    public static Timestamp nowPlus(int hours){
        return new Timestamp(System.currentTimeMillis() + (long) hours * 60 * 60 * 1000);
    }
